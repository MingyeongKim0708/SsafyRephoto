...
VALUES 
(1, '이싸피', 3, '산이 좋네요'),
(1, '김싸프', 4, '이 사진에서 노을의 따뜻한 색감이 정말 매력적입니다. 하지만 하늘과 땅의 경계가 약간 흐릿해서 초점이 분산되는 느낌이 있습니다. 삼분할 구도를 활용해 하늘이나 땅 중 하나에 더 초점을 맞추면 사진의 주제가 더 뚜렷하게 전달될 것 같아요. 그리고 전반적인 밝기를 조금 낮추면 노을의 색감이 더 깊고 강렬하게 표현될 수 있을 것 같습니다. 좋은 작품 잘 봤습니다'),
(1, '김탕피', 5, '
산맥과 노을이 조화를 이루며 매우 아름다운 분위기를 자아내네요
하늘의 붉은색과 파란색이 부드럽게 그라데이션 되어 극적인 효과를 만들어내고
산맥의 실루엣이 층층이 쌓여 있어 깊이감이 느껴집니다.
하지만 산맥의 디테일이 다소 어두워 보일 수 있으니, 그림자 영역을 약간 밝게 조정하면 더 선명한 느낌을 줄 수 있을 것 같습니다.
그리고 구도를 삼분할법에 조금 더 맞췄다면 하늘이나 산맥 중 하나를 더욱 강조할 수 있었을 것 같아요.'),
(2, '이싸피', 2, '삭막하네'),
